...
CREATE TABLE `payments` (
  ...
  `order_id` int(11) NOT NULL,
  `payment_method` enum('credit_card','paypal','bank_transfer','revolut') NOT NULL,
  `payment_status` enum('pending','completed','failed','refunded') NOT NULL,
  `payment_placed` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Logitech G502 Gaming Mouse', 'Cost-efficient gaming mouse with adjustable DPI.', 44.99, 40),
(2, 'HyperX Cloud III', 'Wireless noise-cancelling headphones.', 89.99, 22);
